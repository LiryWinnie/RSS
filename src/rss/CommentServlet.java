...
public class CommentServlet {
	public static final String remoteRSS="https://www.douban.com/feed/subject/";
	private static final FeedServlet Rsslib4jReadRss = null; 
	private static int a=0;
	public static FeedBean test1(String id) throws Exception {   
        RSSHandler remoteRSSHandler = new RSSHandler();   
        URL url = new URL(remoteRSS+id+"/reviews");  
	...
	public static bean test2(int num,String id) throws Exception {   
	...
	public static int test3(String id) throws Exception {   
